...
.method public static g(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    .line 32
    invoke-static {v0, v1}, Landroidx/core/graphics/i;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    .line 50
    invoke-static {v0, v4}, Landroidx/core/graphics/i;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public final a(Landroid/content/Context;Landroidx/core/content/res/e;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 2
    :try_start_0
    iget-object p1, p2, Landroidx/core/content/res/e;->a:[Landroidx/core/content/res/f;
    ...
    .line 24
    iget-boolean v4, v2, Landroidx/core/content/res/f;->c:Z
    ...
    .line 30
    iget v4, v2, Landroidx/core/content/res/f;->e:I
    ...
    .line 36
    iget-object v2, v2, Landroidx/core/content/res/f;->d:Ljava/lang/String;
    ...
    .line 73
    invoke-static {p1, p4}, Landroidx/core/graphics/i;->g(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final b(Landroid/content/Context;[Landroidx/core/provider/j;I)Landroid/graphics/Typeface;
    ...
    .line 5
    :try_start_0
    invoke-virtual {p0, p2, p1}, Landroidx/core/graphics/i;->h([Landroidx/core/provider/j;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 17
    invoke-static {p0, p3}, Landroidx/core/graphics/i;->g(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final c(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 12
    invoke-virtual {p0, v0, p1}, Landroidx/core/graphics/i;->h([Landroidx/core/provider/j;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 35
    check-cast v3, [Landroidx/core/provider/j;

    .line 37
    invoke-virtual {p0, v3, p1}, Landroidx/core/graphics/i;->h([Landroidx/core/provider/j;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    .line 49
    :cond_2
    invoke-static {v0, p3}, Landroidx/core/graphics/i;->g(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final h([Landroidx/core/provider/j;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 9
    ...
    .line 9
    iget-object v5, v4, Landroidx/core/provider/j;->a:Landroid/net/Uri;
    ...
    .line 23
    invoke-virtual {p0, v4}, Landroidx/core/graphics/i;->i(Landroidx/core/provider/j;)Landroid/graphics/fonts/Font;
    ...
    .line 30
    iget-object v6, v4, Landroidx/core/provider/j;->e:Ljava/lang/String;
    ...
    .line 52
    iget v8, v4, Landroidx/core/provider/j;->c:I
    ...
    .line 58
    iget-boolean v8, v4, Landroidx/core/provider/j;->d:Z
    ...
    .line 64
    iget v4, v4, Landroidx/core/provider/j;->b:I
...
.method public i(Landroidx/core/provider/j;)Landroid/graphics/fonts/Font;
    .locals 0
