...
.method public final a()Landroid/graphics/Canvas;
    ...
    .prologue
    .line 1
    iget-object p0, p0, Landroidx/compose/ui/text/android/w;->a:Landroid/graphics/Canvas;
    ...
    .line 8
    invoke-static {p0}, Landroidx/compose/ui/text/internal/a;->c(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .prologue
    .line 1
    sget-object v0, Landroidx/compose/ui/text/android/g;->INSTANCE:Landroidx/compose/ui/text/android/g;

    .line 3
    invoke-virtual {p0}, Landroidx/compose/ui/text/android/w;->a()Landroid/graphics/Canvas;
...
.method public final disableZ()V
    ...
    .prologue
    .line 1
    sget-object v0, Landroidx/compose/ui/text/android/h;->INSTANCE:Landroidx/compose/ui/text/android/h;
    ...
    .line 10
    invoke-static {p0}, Landroidx/compose/ui/text/android/h;->a(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/compose/ui/text/android/h;->b(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    .line 10
    invoke-static {p0, p1, p2}, Landroidx/compose/ui/text/android/h;->c(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/text/android/h;->d(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static/range {p0 .. p7}, Landroidx/compose/ui/text/android/h;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p5}, Landroidx/compose/ui/text/android/h;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .prologue
    .line 1
    sget-object v0, Landroidx/compose/ui/text/android/j;->INSTANCE:Landroidx/compose/ui/text/android/j;
    ...
    .line 10
    invoke-static/range {p0 .. p7}, Landroidx/compose/ui/text/android/j;->a(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/text/android/j;->b(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/text/android/j;->c(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 10
    invoke-static {p0, p1}, Landroidx/compose/ui/text/android/h;->g(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p9}, Landroidx/compose/ui/text/android/h;->h(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final drawTextRun(Ljava/lang/CharSequence;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .prologue
    .line 14
    sget-object v0, Landroidx/compose/ui/text/android/f;->INSTANCE:Landroidx/compose/ui/text/android/f;
...
.method public final enableZ()V
    ...
    .line 10
    invoke-static {p0}, Landroidx/compose/ui/text/android/h;->i(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    .prologue
    .line 19
    sget-object v0, Landroidx/compose/ui/text/android/i;->INSTANCE:Landroidx/compose/ui/text/android/i;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/compose/ui/text/android/i;->a(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {p0, p1}, Landroidx/compose/ui/text/android/i;->b(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    .line 10
    invoke-static {p0, p1}, Landroidx/compose/ui/text/android/i;->c(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
