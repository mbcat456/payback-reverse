...
.method public final configure(Lcom/cardinalcommerce/a/KeyPairGeneratorSpi$ECMQV;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/cardinalcommerce/a/SignatureSpi$ecDetDSASha3_224;->cca_continue:Ljava/security/SecureRandom;
...
.method public final init()Lcom/cardinalcommerce/a/KeyAgreementSpi$CDHwithSHA224KDFAndSharedInfo;
    ...
    .line 3
    iget-object p0, p0, Lcom/cardinalcommerce/a/SignatureSpi$ecDetDSASha3_224;->cca_continue:Ljava/security/SecureRandom;

    .line 5
    invoke-direct {v0, p0}, Lcom/cardinalcommerce/a/KeyPairGeneratorSpi$Ed25519;-><init>(Ljava/security/SecureRandom;)V
    ...
    .line 12
    iget-object v1, v0, Lcom/cardinalcommerce/a/KeyPairGeneratorSpi$Ed25519;->getInstance:[B

    .line 14
    const/4 v2, 0x0

    .line 15
    invoke-static {v1, v2, p0, v2}, Lcom/cardinalcommerce/a/arrayStop;->init([BI[BI)V

    .line 18
    new-instance v1, Lcom/cardinalcommerce/a/KeyPairGeneratorSpi$X448;

    .line 20
    invoke-direct {v1, p0, v2}, Lcom/cardinalcommerce/a/KeyPairGeneratorSpi$X448;-><init>([BI)V
