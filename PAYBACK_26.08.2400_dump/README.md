# PAYBACK Android 26.08.2400 - unpacked and decrypted dump

| | |
|---|---|
| Package | `it.payback.client.android` |
| Version | `26.08.2400` (versionCode `1000090637`) |
| Source bundle | APKM excluded from this folder |
| Files in this folder | 44372 |
| Size | 414.8 MB |
...
| Path | Contents |
|---|---|
| `original/` | The five APKs from the bundle, plus the bundle metadata and signature. The APKM container itself is excluded. |
